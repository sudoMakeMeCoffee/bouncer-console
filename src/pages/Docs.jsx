...
const Docs = () => {
  ...
  return (
    <div className="bg-[#121216] min-h-screen py-16 px-6">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
          Documentation
        </h1>
        <p className="text-gray-400 max-w-2xl mx-auto">
          Explore the docs to learn how to build, integrate, and scale with our
          platform. Whether you’re just getting started or deep-diving into the
          API, we’ve got you covered.
        </p>
      </div>
