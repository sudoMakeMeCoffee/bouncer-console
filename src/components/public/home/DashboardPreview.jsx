...
import { FaPlus, FaServer, FaChartLine, FaBell } from "react-icons/fa";
      ...
      <div className="hidden md:block w-full max-w-6xl">
        ...
        <div className="bg-[#1e1e22] rounded-b-xl shadow-xl p-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-3xl font-bold text-white">Modern Dashboard</h1>
      ...
      <div className="block md:hidden relative bg-black rounded-[3rem] border-[8px] border-gray-700 shadow-2xl w-[375px] h-[812px] overflow-hidden">
        ...
        <div className="relative z-10 h-full w-full overflow-y-auto no-scrollbar">
          <div className="bg-[#1e1e22] p-4 py-10">
            <h1 className="text-xl font-bold text-white">Modern Dashboard</h1>
            <button className="flex items-center gap-2 bg-[#212126] text-white px-3 py-1 rounded-lg mt-3">
              <FaBell /> Notifications
            </button>
            ...
            <div className="mt-6">
              <Link
                to="/dashboard/apps/new"
                className="flex-1 bg-blue-500 hover:bg-blue-600 text-white p-3 rounded-lg flex items-center justify-center gap-2 transition"
              >
